...
<head>
    ...
    <style>
        :root { --primary: #6366f1; --primary-light: #8b5cf6; --primary-glow: rgba(99, 102, 241, 0.4); --bg: #0f172a; --card-bg: rgba(30, 41, 59, 0.7); --glass-border: rgba(255, 255, 255, 0.1); --text: #f8fafc; --text-muted: #94a3b8; }
        * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        .aurora-bg {
            ...
            background-image: radial-gradient(at 0% 0%, hsla(253,16%,7%,1) 0, transparent 50%), 
                              radial-gradient(at 75% 25%, hsla(225,39%,30%,0.8) 0, transparent 50%), 
                              radial-gradient(at 100% 100%, hsla(339,49%,30%,0.6) 0, transparent 50%);
        ...
        .card { 
            ...
            max-width: 380px; 
            text-align: center; 
            box-shadow: 0 20px 40px rgba(0,0,0,0.4), 0 0 40px var(--primary-glow); /* 增加卡片光晕 */
            z-index: 10; 
        ...
        .icon { 
            ...
            filter: drop-shadow(0 0 10px var(--primary-glow)); /* 柔和图标阴影 */
        }
        ...
        input:focus { 
            ...
            box-shadow: 0 0 0 4px rgba(99, 102, 241, 0.3); /* 增强聚焦光晕 */
        ...
        button { 
            ...
            border-radius: 18px; 
            border: none; 
            background: linear-gradient(135deg, var(--primary), var(--primary-light)); /* 渐变按钮 */
            color: white; 
            font-size: 17px; 
            font-weight: 700; 
            cursor: pointer; 
        ...
        button:active { transform: scale(0.98); box-shadow: 0 5px 10px -5px var(--primary-glow); }
        button:disabled { background: var(--card-bg); color: var(--text-muted); cursor: not-allowed; box-shadow: none; }
...
<body>
    ...
    <div class="card">
        <div class="icon">✨</div>
        <h1>极光记账</h1>
        <p>Aurora Accounting - 极简高效的个人记账</p>
