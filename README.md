...
1. 在 **"Settings"** → **"Triggers"** 中添加自定义域名
2. 按照提示配置 DNS 记录
...
1. 在 **"Settings"** → **"Variables"** 中添加
2. 例如添加 `ENVIRONMENT = "production"`

## 🚨 重要提醒

### KV 数据持久性

- Cloudflare KV 是全球分布的，数据可能有轻微延迟
- 免费版本有读写限制（每天 100,000 次读取，1,000 次写入）
- 数据会自动持久化，不需要额外配置

### 安全性

- 当前版本没有用户认证，任何人都可以访问和修改数据
- 如需用户隔离，需要在代码中实现认证机制
